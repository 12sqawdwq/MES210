...
\lstdefinestyle{matlabstyle}{
    ...
    emph={sin,cos,exp,double,abs,angle,fft,fftshift,ifft,ifftshift,real,roots,freqs,conv,interp1,mean,max,plot,stem,subplot,legend,xlabel,ylabel,title,grid,axis,xlim,hold,disp,fprintf,exist,tf,impulse,lsim,ode45},
    emphstyle=\color{teal!70!black},
    emph={[2]figure,if,else,end,for,while,function,return},
    emphstyle={[2]\bfseries\color{violet!75!black}},
    numbers=left,
...
{\Needspace{12\baselineskip}\lstset{style=matlabstyle}}
{}
...
\begin{titlepage}
    ...
    \begin{tabular}{rl}
        Name: & Ziyu.Zhao \\
        Student ID: & 2362409 \\
        Module Code: & MES210TC \\
        Module Title: & Continuous and Discrete Time Signals and Systems \\
    \end{tabular}
    \vfill
...
This report presents MATLAB-based solutions for the MES210TC Signals and Systems laboratory coursework. The work covers basic continuous-time signal generation, elementary signal transformations, continuous-time LTI system analysis, numerical convolution, Fourier series spectra, frequency-domain steady-state response, RLC low-pass filtering, AM modulation and demodulation, and pole-zero based frequency-response and stability analysis. The organization follows the laboratory manual requirements, while the theoretical treatment is based on standard continuous-time signals and systems theory \cite{labmanual,oppenheim}. For each task, the theoretical principle is first stated, followed by key MATLAB implementation details, result figures, and interpretation.

\section{Experiment 1: Continuous-Time Signals and Time-Domain LTI Analysis}

\subsection{Generation and Visualization of Basic Continuous-Time Signals}
...
\subsubsection{Principle and Formula Explanation}
...
Vectorized time arrays are used to approximate continuous-time signals. Logical expressions such as \texttt{t >= 0} and \texttt{t >= 0 \& t <= 2} produce numerical masks. This avoids loops and follows normal MATLAB array-operation practice \cite{mathworksMatlab}.
...
\subsection{Basic Operations on Continuous-Time Signals}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.76\textwidth]{figures/Q1_2_fig1.png}
...
\subsection{Time-Domain Analysis of a Continuous-Time LTI System}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.74\textwidth]{figures/Q1_3_fig1.png}
...
\subsection{Numerical Convolution of Continuous-Time Signals}
...
\]
The factor \(p\) is required because MATLAB's \texttt{conv} computes a summation, whereas the continuous convolution is an integral \cite{mathworksConv}.
...
\subsubsection{Results, Numerical Analysis, and Interpretation}
\begin{figure}[H]
    \centering
    \begin{subfigure}{0.48\textwidth}
...
\section{Experiment 2: Fourier and Frequency-Domain Analysis}

\subsection{Fourier Series Analysis of Periodic Rectangular Pulses}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.78\textwidth]{figures/Q2_1_fig1.png}
...
\subsection{Frequency-Domain Analysis of a Continuous-Time LTI System}
...
\subsubsection{Results, Numerical Values, and Interpretation}
\begin{figure}[H]
    \centering
    \begin{subfigure}{0.48\textwidth}
...
\section{Experiment 3: RLC Filtering and AM System Simulation}

\subsection{RLC Second-Order Low-Pass Filter}
...
\subsection{AM Modulation, Coherent Demodulation, and Low-Pass Filtering}
...
\subsubsection{Code Analysis}
FFT and \texttt{fftshift} are used to implement an ideal frequency-domain low-pass filter \cite{mathworksFFT}. The cutoff keeps the baseband frequencies at 8 and 16 rad/s and rejects the components near 240 rad/s.
...
\section{Experiment 4: Pole-Zero and Geometric Frequency-Response Analysis}

\subsection{Geometric Evaluation of Frequency Response from Pole-Zero Plot}
...
The geometric result and the \texttt{freqs} result overlap, verifying the computation with MATLAB's analog frequency-response evaluation \cite{mathworksFreqs}. The supplementary illustration at \(f_0=10\) Hz shows the distance vectors directly. At that point,
\[
|H(j\omega_0)|=
...
\subsection{Pole-Zero Map and Stability}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.78\textwidth]{figures/Q4_2_fig1.png}
...
\bibitem{labmanual}
Xi'an Jiaotong-Liverpool University, \textit{MES210TC Continuous and Discrete Time Signals and Systems Laboratory Manual}, Academic Year 2025--2026.

\bibitem{oppenheim}
A. V. Oppenheim, A. S. Willsky, and S. H. Nawab, \textit{Signals and Systems}, 2nd ed. Upper Saddle River, NJ: Prentice Hall, 1997.

\bibitem{lathi}
B. P. Lathi and R. A. Green, \textit{Linear Systems and Signals}, 3rd ed. Oxford, UK: Oxford University Press, 2018.

\bibitem{mathworksMatlab}
MathWorks, \textit{MATLAB Documentation: Matrix and Array Operations}. Available: \url{https://www.mathworks.com/help/matlab/matrices-and-arrays.html}

\bibitem{mathworksConv}
MathWorks, \textit{conv: Convolution and Polynomial Multiplication}. Available: \url{https://www.mathworks.com/help/matlab/ref/conv.html}

\bibitem{mathworksFFT}
MathWorks, \textit{fft: Fast Fourier Transform}. Available: \url{https://www.mathworks.com/help/matlab/ref/fft.html}

\bibitem{mathworksFreqs}
MathWorks, \textit{freqs: Frequency Response of Analog Filter}. Available: \url{https://www.mathworks.com/help/signal/ref/freqs.html}
